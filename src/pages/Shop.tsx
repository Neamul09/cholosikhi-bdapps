      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-4xl font-black">{language === 'bn' ? 'শপ' : 'SHOP'}</h1>
          </div>
        ...
        <div className="bg-panel border-2 border-border-subtle px-6 py-3 rounded-2xl flex items-center gap-4 shadow-xl">
           <div className="flex flex-col">
             <span className="text-[10px] font-black text-app-fg/40 uppercase tracking-widest">{language === 'bn' ? 'আপনার রত্ন' : 'YOUR GEMS'}</span>
        ...
        {shopItems.map((item, i) => (
          <motion.div
            ...
            className={clsx(
              ...
              item.disabled ? "opacity-60 border-border-subtle" : "border-blue-500/20 hover:border-blue-500/50 hover:shadow-2xl hover:shadow-blue-500/10 cursor-pointer"
            )}
          ...
          >
            ...
            <p className="text-sm font-bold text-app-fg/60 mb-8 px-4 leading-snug">
              {item.desc}
            </p>
              ...
              <div className={clsx(
                ...
                {item.id === 'heart_refill' && hearts >= 5 ? (
                  language === 'bn' ? 'পূর্ণ' : 'FULL'
                   ...
                   language === 'bn' ? `${boostTimeLeft} মিনিট বাকি` : `${boostTimeLeft}m LEFT`
                ) : (
                  <>
         ...
         <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="text-center md:text-left">
              <div className="flex items-center gap-2 mb-2 justify-center md:justify-start">
                ...
                <span className="font-black uppercase tracking-widest text-xs opacity-80">{language === 'bn' ? 'শীঘ্রই আসছে' : 'COMING SOON'}</span>
              </div>
              <h2 className="text-3xl font-black mb-4">{language === 'bn' ? 'বিশেষ আইটেম এবং ব্যাজ' : 'Special Items & Badges'}</h2>
              <p className="font-bold opacity-80 max-w-md">
                {language === 'bn' ? 'আপনার প্রোফাইল কাস্টমাইজ করতে বিশেষ ব্যাজ এবং থিম আনলক করুন।' : 'Unlock unique profile badges and themes to show off your skills.'}
              </p>
            </div>
